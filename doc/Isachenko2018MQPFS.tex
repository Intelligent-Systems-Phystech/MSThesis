...
\begin{multline*}
	g(\ba_y, \lambda, \bmu) 
	= \min_{\ba_x \in \bbR^n} L(\ba_x, \ba_y, \lambda, \bmu) = % \frac{1}{4\alpha_1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right)^T \bQ_x^{-1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right) \\
