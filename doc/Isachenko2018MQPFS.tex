...
The dual problem is
\begin{equation}
	\min_{\lambda, \, \bmu \geq \bZero_r} g(\ba_y, \lambda, \bmu) = \min_{\lambda, \, \bmu \geq \bZero_r}  \left[\max_{\ba_y \in \bbR^r} L(\ba_x, \ba_y, \lambda, \bmu) \right].
	\label{eq:dual}
\end{equation}
...
\begin{multline*}
	g(\ba_y, \lambda, \bmu) 
	= \max_{\ba_y \in \bbR^r} L(\ba_x, \ba_y, \lambda, \bmu) = % \frac{1}{4\alpha_1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right)^T \bQ_x^{-1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right) \\
	%- \frac{1}{2\alpha_1} \bQ_x^{-1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right)^T \bQ_x^{-1} \bB \ba_y - \lambda \left( \frac{1}{2\alpha_1} \bOne_n ^T \bQ_x^{-1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right) - 1 \right) \\
	%- \frac{\alpha_2}{2\alpha_1} \bmu^T \bQ_x^{-1} \left( \alpha_2 \cdot \bB \ba_y +\lambda \cdot \bOne_n + \bmu \right)  - \alpha_3 \cdot \ba_y^T \bQ_y \ba_y = 
...
It brings to the quadratic problem~\eqref{eq:dual_maxmin} with~$n + r + 1$ variables. We obtain the vector~$\ba_x$ by solving~\eqref{eq:dual_maxmin} and the vector~$\ba_y$ from~\eqref{eq:ax}.
